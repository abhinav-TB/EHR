    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow rounded-lg text-gray-900">
      ...
      <div className="mb-6">
        <button
          ...
          onClick={() => window.location.href = '/patient/new'}
        >
          Add New Patient
        </button>
      </div>
      ...
      <div className="flex gap-2 mb-6 text-gray-900">
        <input
          className="flex-1 p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:outline-none text-black"
          value={query}
